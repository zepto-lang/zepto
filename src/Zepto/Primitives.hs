...
primitives = [ ("+", numericPlusop (+), "add two or more values")
             ...
             , ("numerator", unaryOp numerator, "gets numerator of a number")
             , ("denominator", unaryOp denominator, "gets denominator of a number")
             ...
             , ("list:car", unaryOp car, "take head of list")
             , ("list:cdr", unaryOp cdr, "take tail of list")
